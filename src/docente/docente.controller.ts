...
export class DocenteController {
  ...
  @Post('register')
  register(@Body() createDocenteDto: CreateDocenteDto) {
    return this.docenteService.register(createDocenteDto);
  }

  @Post('login')
  login(@Body() loginDocenteDto: LoginDocenteDto) {
    return this.docenteService.login(loginDocenteDto);
  }
}